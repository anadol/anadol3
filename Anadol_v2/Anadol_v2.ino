...
void setup(void)
{
  ...
  //Web sayfamızın html,css ve javascript kodları
    ...
    webPage += "<ul id=\"cerceve\"><h3 style=\"text-align:center\">1 - Kullanıcı Kontrollü Araç Modu</h3><br>";
    webPage += "<div class='row'>";
    webPage += "<div class=\"col-md-5\"></div>";
    webPage += "<div class=\"col-md-2\">";
    webPage += "<a href=\"/ileri\"><button  id='forward' class='btn btn-primary btn-block' type=\"button\">İleri Git</button></a>";
    webPage += "</div>";
    webPage += "<div class=\"col-md-5\"></div>";
    webPage += "</div><br>";
    webPage += "<div class='row'>";
